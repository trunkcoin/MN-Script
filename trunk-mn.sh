...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='trunk.conf'
CONFIGFOLDER='/root/.trunk'
COIN_DAEMON='trunkd'
COIN_CLI='trunk-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/trunkcoin/TrunkCoin/files/3005323/Trunk_.Daemon_Ubunru_16.04.tar.gz'
...
function download_node() {
  ...
  wget -q $COIN_TGZ
  tar xzvf Trunk_.Daemon_Ubunru_16.04.tar.gz
  cd rev >/dev/null 2>&1
...
function important_information() {
 ...
 echo -e "${BLUE}================================================================================================================================"
 echo -e "${CYAN}Follow twitter to stay updated.  https://twitter.com/trunkCoin${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${CYAN}Ensure Node is fully SYNCED with BLOCKCHAIN.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Usage Commands.${NC}"
 echo -e "${GREEN}trunk-cli masternode status${NC}"
 echo -e "${GREEN}trunk-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
